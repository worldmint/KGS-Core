...
public:
    ...
    void setZKingscoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzKGS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzKGS_clicked();
    void on_pushButtonZKingscoinControl_clicked();
