...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Kingscoin address"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zKGS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Kingscoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Kingscoin addresses"));
...
/** Creates context menu, its actions, and kingscoins up all the relevant signals for mouse events. */
