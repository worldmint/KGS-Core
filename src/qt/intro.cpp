...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Kingscoin Core"),
     ...
     * override -datadir in the kingscoin.conf file in the default data directory
     * (to be consistent with kingscoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
