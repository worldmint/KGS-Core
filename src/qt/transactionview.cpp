                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Kingscoin from zKingscoin"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zKingscoin"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zKingscoin));
