...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"kingscoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"kingscoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use kingscoind, or the -server option to kingscoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
