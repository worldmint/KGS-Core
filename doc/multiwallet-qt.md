...
In order to support loading of multiple wallets in kingscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kingscoin.cpp.
...
Changes to kingscoin.cpp
----------------------
kingscoin.cpp is the entry point into kingscoin-qt, and as such, will require some minor modifications to provide hooks for
